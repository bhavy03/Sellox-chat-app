    ...
    <>
      <div className="relative shadow-2xl">
        <div className="flex h-14 items-center bg-transparent rounded-xl shadow-xl outline outline-offset-0 outline-[#404144]/10 ">
          <div>
            <li className="ml-8 mr-auto list-none text-2xl text-white font-semibold letter-spacing py-1.5 backdrop-blur-lg rounded-lg">
              <Link to="/">
                <img
                  src={logo}
                  alt="SELLOX"
          ...
          <div className="md:flex md:ml-auto md:mr-5 md:space-x-10 flex flex-row ml-auto space-x-5 mr-3 list-none items-center">
            <div className="hidden md:space-x-10 md:flex">
              <li>
                <Link to="/">
                  <MdHomeFilled
                    className="w-6 h-6 hover:shadow-lg"
                    style={{ color: "white" }}
                  />
                </Link>
              </li>
            ...
            {isAuthenticated ? (
              <li>
                <Link to={`user/${myId}`}>
                  <FaCircleUser
                    className="w-5 h-6 md:static absolute top-4 right-16"
                    style={{ color: "white" }}
                  />
                </Link>
              </li>
            ...
            {isAuthenticated ? (
              ...
              <div className="md:flex hidden">
                <li className="bg-zinc-50 text-black text-sm font-semibold hover:text-white hover:bg-[#38caff] hover:font-bold px-2 py-1 rounded-md">
